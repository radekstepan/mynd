...
EnrichmentWidget = (function(_super) {
  ...
  EnrichmentWidget.prototype.exportClick = function(e) {
    var ex;
    ex = new Exporter($(e.target), this.selected);
...
Exporter = (function() {
  ...
  Exporter.prototype.download = 'widget.tsv';

  Exporter.prototype.url = root.webkitURL || root.URL;

  function Exporter(a, data) {
    this.destroy = __bind(this.destroy, this);
    var builder;
    builder = new (root.BlobBuilder || root.WebKitBlobBuilder || root.MozBlobBuilder)();
    builder.append("nečum pičo");
    a.attr('download', this.download);
    (this.href = this.url.createObjectURL(builder.getBlob(this.mime))) && (a.attr('href', this.href));
    a.attr('data-downloadurl', [this.mime, this.download, this.href].join(':'));
  }
